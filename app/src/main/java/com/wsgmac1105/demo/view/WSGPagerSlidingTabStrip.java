...
/**
 * Created by wushaoge on 15/11/16.
 */
public class WSGPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public WSGPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public WSGPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WSGPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
